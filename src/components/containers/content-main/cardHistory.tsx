...
const CardHistory = () => (
  <div className="flex w-full justify-center bg-white py-40 relative">
    <div className="flex flex-col max-w-screen-xl w-full items-center justify-center gap-8 px-4 sm:px-6 lg:px-8">
      <h1 className="text-center max-w-2xl text-[80px] font-bold text-cosco-700 leading-[6rem]">
        Conoce nuestra historia
      </h1>
      <p className="text-center max-w-2xl text-lg font-normal text-cosco-600">
